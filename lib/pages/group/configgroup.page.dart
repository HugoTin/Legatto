...
class ConfigGroup extends StatelessWidget {
  final String id;
  const ConfigGroup(this.id, {super.key});
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 20),
                          RowNaipe("id", "images/NaipeViolino.png", "Violino",
                              1, true),
                          SizedBox(height: 15),
                          RowNaipe("id", "images/NaipeTrompete.png", "Trompete",
                              0, false),
                          SizedBox(height: 15),
                          RowNaipe("id", "images/NaipeClarinete.png",
                              "Clarinete", 0, true)
                        ],
                      ),
                    ],
